...
module steamm::cpmm {
    ...
    public fun intent_swap<A, B, W: drop, P>(
        pool: &mut Pool<A, B, CpQuoter<W>, P>,
        amount_in: u64,
        a2b: bool,
    ...
    public fun offset<A, B, W: drop, P>(pool: &Pool<A, B, CpQuoter<W>, P>): u64 {
        pool.quoter().offset
    }
    ...
    public fun k<A, B, Quoter: store, P>(
        ...
        let (total_funds_a, total_funds_b) = pool.btoken_amounts();
    ...
    public(package) fun max_amount_in_on_a2b<A, B, W: drop, P>(
        ...
        let (reserve_in, reserve_out) = pool.btoken_amounts();
