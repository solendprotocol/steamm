module slamm::fees {
    ...
    public fun fee_ratio_(
        ...
        (fees.fee_numerator, fees.fee_denominator)
    }
    ...
    public fun fee_numerator(fees: &FeeConfig): u64 { fees.fee_numerator }
    public fun fee_denominator(fees: &FeeConfig): u64 { fees.fee_denominator }
    public fun min_fee(fees: &FeeConfig): u64 { fees.min_fee }
    ...
    #[test_only]
    public(package) fun fee_numerator_mut(fees: &mut FeeConfig): &mut u64 { &mut fees.fee_numerator }
    #[test_only]
    public(package) fun min_fee_mut(fees: &mut FeeConfig): &mut u64 { &mut fees.min_fee }
}
