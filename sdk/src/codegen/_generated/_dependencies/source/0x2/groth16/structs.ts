...
export class Curve implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: CurveFields, ) { this.$fullTypeName = composeSuiType( Curve.$typeName, ...typeArgs ) as `${typeof PKG_V28}::groth16::Curve`; this.$typeArgs = typeArgs;
...
export class PreparedVerifyingKey implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: PreparedVerifyingKeyFields, ) { this.$fullTypeName = composeSuiType( PreparedVerifyingKey.$typeName, ...typeArgs ) as `${typeof PKG_V28}::groth16::PreparedVerifyingKey`; this.$typeArgs = typeArgs;
...
export class ProofPoints implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: ProofPointsFields, ) { this.$fullTypeName = composeSuiType( ProofPoints.$typeName, ...typeArgs ) as `${typeof PKG_V28}::groth16::ProofPoints`; this.$typeArgs = typeArgs;
...
export class PublicProofInputs implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: PublicProofInputsFields, ) { this.$fullTypeName = composeSuiType( PublicProofInputs.$typeName, ...typeArgs ) as `${typeof PKG_V28}::groth16::PublicProofInputs`; this.$typeArgs = typeArgs;
