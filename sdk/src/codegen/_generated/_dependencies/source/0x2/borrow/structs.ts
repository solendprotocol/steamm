...
export class Referent<T extends TypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [ToTypeStr<T>], fields: ReferentFields<T>, ) { this.$fullTypeName = composeSuiType( Referent.$typeName, ...typeArgs ) as `${typeof PKG_V28}::borrow::Referent<${ToTypeStr<T>}>`; this.$typeArgs = typeArgs;
