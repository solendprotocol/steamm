...
export class G1 implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: G1Fields, ) { this.$fullTypeName = composeSuiType( G1.$typeName, ...typeArgs ) as `${typeof PKG_V28}::bls12381::G1`; this.$typeArgs = typeArgs;
...
export class G2 implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: G2Fields, ) { this.$fullTypeName = composeSuiType( G2.$typeName, ...typeArgs ) as `${typeof PKG_V28}::bls12381::G2`; this.$typeArgs = typeArgs;
...
export class GT implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: GTFields, ) { this.$fullTypeName = composeSuiType( GT.$typeName, ...typeArgs ) as `${typeof PKG_V28}::bls12381::GT`; this.$typeArgs = typeArgs;
...
export class Scalar implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: ScalarFields, ) { this.$fullTypeName = composeSuiType( Scalar.$typeName, ...typeArgs ) as `${typeof PKG_V28}::bls12381::Scalar`; this.$typeArgs = typeArgs;
