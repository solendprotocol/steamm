...
export class VersionChangeCap implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: VersionChangeCapFields, ) { this.$fullTypeName = composeSuiType( VersionChangeCap.$typeName, ...typeArgs ) as `${typeof PKG_V28}::versioned::VersionChangeCap`; this.$typeArgs = typeArgs;
...
export class Versioned implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: VersionedFields, ) { this.$fullTypeName = composeSuiType( Versioned.$typeName, ...typeArgs ) as `${typeof PKG_V28}::versioned::Versioned`; this.$typeArgs = typeArgs;
