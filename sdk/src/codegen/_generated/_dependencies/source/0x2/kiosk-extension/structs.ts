...
export class ExtensionKey<Ext extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<Ext>], fields: ExtensionKeyFields<Ext>, ) { this.$fullTypeName = composeSuiType( ExtensionKey.$typeName, ...typeArgs ) as `${typeof PKG_V28}::kiosk_extension::ExtensionKey<${PhantomToTypeStr<Ext>}>`; this.$typeArgs = typeArgs;
