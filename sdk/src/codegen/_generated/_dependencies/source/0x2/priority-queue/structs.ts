...
export class Entry<T extends TypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [ToTypeStr<T>], fields: EntryFields<T>, ) { this.$fullTypeName = composeSuiType( Entry.$typeName, ...typeArgs ) as `${typeof PKG_V28}::priority_queue::Entry<${ToTypeStr<T>}>`; this.$typeArgs = typeArgs;
...
export class PriorityQueue<T extends TypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [ToTypeStr<T>], fields: PriorityQueueFields<T>, ) { this.$fullTypeName = composeSuiType( PriorityQueue.$typeName, ...typeArgs ) as `${typeof PKG_V28}::priority_queue::PriorityQueue<${ToTypeStr<T>}>`; this.$typeArgs = typeArgs;
