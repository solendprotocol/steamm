...
export interface RegistryFields { id: ToField<UID>; version: ToField<Version>; amms: ToField<Table<ToPhantom<TypeName>, ToPhantom<ID>>>; banks: ToField<Table<ToPhantom<TypeName>, ToPhantom<ID>>> }
...
export class Registry implements StructClass { __StructClass = true as const;
 ...
 readonly id: ToField<UID>; readonly version: ToField<Version>; readonly amms: ToField<Table<ToPhantom<TypeName>, ToPhantom<ID>>>; readonly banks: ToField<Table<ToPhantom<TypeName>, ToPhantom<ID>>>
 ...
 static fromJSONField( field: any ): Registry { return Registry.reified( ).new( { id: decodeFromJSONField(UID.reified(), field.id), version: decodeFromJSONField(Version.reified(), field.version), amms: decodeFromJSONField(Table.reified(reified.phantom(TypeName.reified()), reified.phantom(ID.reified())), field.amms), banks: decodeFromJSONField(Table.reified(reified.phantom(TypeName.reified()), reified.phantom(ID.reified())), field.banks) } ) }
