...
export function fundsDeployed( tx: Transaction, typeArgs: [string, string], args: FundsDeployedArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bank::funds_deployed`, typeArguments: typeArgs, arguments: [ obj(tx, args.bank), obj(tx, args.lendingMarket), obj(tx, args.clock) ], }) }
...
export function btokenRatio( tx: Transaction, typeArgs: [string, string], args: BtokenRatioArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bank::btoken_ratio`, typeArguments: typeArgs, arguments: [ obj(tx, args.bank), obj(tx, args.lendingMarket), obj(tx, args.clock) ], }) }
...
export function burnBtokens( tx: Transaction, typeArgs: [string, string], args: BurnBtokensArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bank::burn_btokens`, typeArguments: typeArgs, arguments: [ obj(tx, args.bank), obj(tx, args.lendingMarket), obj(tx, args.btokens), pure(tx, args.btokenAmount, `u64`), obj(tx, args.clock) ], }) }
...
export function compoundInterestIfAny( tx: Transaction, typeArgs: [string, string], args: CompoundInterestIfAnyArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bank::compound_interest_if_any`, typeArguments: typeArgs, arguments: [ obj(tx, args.bank), obj(tx, args.lendingMarket), obj(tx, args.clock) ], }) }
...
export interface EffectiveUtilisationBpsArgs { self: TransactionObjectInput; lendingMarket: TransactionObjectInput; clock: TransactionObjectInput }

export function effectiveUtilisationBps( tx: Transaction, typeArgs: [string, string], args: EffectiveUtilisationBpsArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bank::effective_utilisation_bps`, typeArguments: typeArgs, arguments: [ obj(tx, args.self), obj(tx, args.lendingMarket), obj(tx, args.clock) ], }) }
...
export function fromBtokens( tx: Transaction, typeArgs: [string, string], args: FromBtokensArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bank::from_btokens`, typeArguments: typeArgs, arguments: [ obj(tx, args.bank), obj(tx, args.lendingMarket), pure(tx, args.btokenAmount, `u64`), obj(tx, args.clock) ], }) }
...
export function mintBtokens( tx: Transaction, typeArgs: [string, string], args: MintBtokensArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bank::mint_btokens`, typeArguments: typeArgs, arguments: [ obj(tx, args.bank), obj(tx, args.lendingMarket), obj(tx, args.coins), pure(tx, args.coinAmount, `u64`), obj(tx, args.clock) ], }) }
...
export function needsRebalance( tx: Transaction, typeArgs: [string, string], args: NeedsRebalanceArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bank::needs_rebalance`, typeArguments: typeArgs, arguments: [ obj(tx, args.bank), obj(tx, args.lendingMarket), obj(tx, args.clock) ], }) }
...
export function prepareForPendingWithdraw( tx: Transaction, typeArgs: [string, string], args: PrepareForPendingWithdrawArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bank::prepare_for_pending_withdraw`, typeArguments: typeArgs, arguments: [ obj(tx, args.bank), obj(tx, args.lendingMarket), pure(tx, args.withdrawAmount, `u64`), obj(tx, args.clock) ], }) }
...
export function targetUtilisationBpsUnchecked( tx: Transaction, typeArgs: [string, string], self: TransactionObjectInput ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bank::target_utilisation_bps_unchecked`, typeArguments: typeArgs, arguments: [ obj(tx, self) ], }) }
...
export function toBtokens( tx: Transaction, typeArgs: [string, string], args: ToBtokensArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bank::to_btokens`, typeArguments: typeArgs, arguments: [ obj(tx, args.bank), obj(tx, args.lendingMarket), pure(tx, args.amount, `u64`), obj(tx, args.clock) ], }) }
...
export function totalFunds( tx: Transaction, typeArgs: [string, string], args: TotalFundsArgs ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bank::total_funds`, typeArguments: typeArgs, arguments: [ obj(tx, args.bank), obj(tx, args.lendingMarket), obj(tx, args.clock) ], }) }

export function utilisationBufferBpsUnchecked( tx: Transaction, typeArgs: [string, string], self: TransactionObjectInput ) { return tx.moveCall({ target: `${PUBLISHED_AT}::bank::utilisation_buffer_bps_unchecked`, typeArguments: typeArgs, arguments: [ obj(tx, self) ], }) }
