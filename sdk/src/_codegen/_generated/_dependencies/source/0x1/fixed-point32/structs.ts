...
export function isFixedPoint32(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V10}::fixed_point32::FixedPoint32`; }
...
export class FixedPoint32 implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V10}::fixed_point32::FixedPoint32`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = FixedPoint32.$typeName; readonly $fullTypeName: `${typeof PKG_V10}::fixed_point32::FixedPoint32`; readonly $typeArgs: []; readonly $isPhantom = FixedPoint32.$isPhantom;

 readonly value: ToField<"u64">

 private constructor(typeArgs: [], fields: FixedPoint32Fields, ) { this.$fullTypeName = composeSuiType( FixedPoint32.$typeName, ...typeArgs ) as `${typeof PKG_V10}::fixed_point32::FixedPoint32`; this.$typeArgs = typeArgs;

 this.value = fields.value; }

 static reified( ): FixedPoint32Reified { return { typeName: FixedPoint32.$typeName, fullTypeName: composeSuiType( FixedPoint32.$typeName, ...[] ) as `${typeof PKG_V10}::fixed_point32::FixedPoint32`, typeArgs: [ ] as [], isPhantom: FixedPoint32.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => FixedPoint32.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => FixedPoint32.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => FixedPoint32.fromBcs( data, ), bcs: FixedPoint32.bcs, fromJSONField: (field: any) => FixedPoint32.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => FixedPoint32.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => FixedPoint32.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => FixedPoint32.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => FixedPoint32.fetch( client, id, ), new: ( fields: FixedPoint32Fields, ) => { return new FixedPoint32( [], fields ) }, kind: "StructClassReified", } }
