...
export class Entry<K extends TypeArgument, V extends TypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [ToTypeStr<K>, ToTypeStr<V>], fields: EntryFields<K, V>, ) { this.$fullTypeName = composeSuiType( Entry.$typeName, ...typeArgs ) as `${typeof PKG_V28}::vec_map::Entry<${ToTypeStr<K>}, ${ToTypeStr<V>}>`; this.$typeArgs = typeArgs;
...
export class VecMap<K extends TypeArgument, V extends TypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [ToTypeStr<K>, ToTypeStr<V>], fields: VecMapFields<K, V>, ) { this.$fullTypeName = composeSuiType( VecMap.$typeName, ...typeArgs ) as `${typeof PKG_V28}::vec_map::VecMap<${ToTypeStr<K>}, ${ToTypeStr<V>}>`; this.$typeArgs = typeArgs;
