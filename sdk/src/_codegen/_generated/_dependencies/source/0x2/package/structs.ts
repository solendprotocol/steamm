...
export class Publisher implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: PublisherFields, ) { this.$fullTypeName = composeSuiType( Publisher.$typeName, ...typeArgs ) as `${typeof PKG_V28}::package::Publisher`; this.$typeArgs = typeArgs;
...
export class UpgradeCap implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: UpgradeCapFields, ) { this.$fullTypeName = composeSuiType( UpgradeCap.$typeName, ...typeArgs ) as `${typeof PKG_V28}::package::UpgradeCap`; this.$typeArgs = typeArgs;
...
export class UpgradeReceipt implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: UpgradeReceiptFields, ) { this.$fullTypeName = composeSuiType( UpgradeReceipt.$typeName, ...typeArgs ) as `${typeof PKG_V28}::package::UpgradeReceipt`; this.$typeArgs = typeArgs;
...
export class UpgradeTicket implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: UpgradeTicketFields, ) { this.$fullTypeName = composeSuiType( UpgradeTicket.$typeName, ...typeArgs ) as `${typeof PKG_V28}::package::UpgradeTicket`; this.$typeArgs = typeArgs;
