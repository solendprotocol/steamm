...
export class VecSet<K extends TypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [ToTypeStr<K>], fields: VecSetFields<K>, ) { this.$fullTypeName = composeSuiType( VecSet.$typeName, ...typeArgs ) as `${typeof PKG_V28}::vec_set::VecSet<${ToTypeStr<K>}>`; this.$typeArgs = typeArgs;
