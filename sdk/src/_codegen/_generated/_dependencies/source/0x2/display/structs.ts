...
export class Display<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: DisplayFields<T>, ) { this.$fullTypeName = composeSuiType( Display.$typeName, ...typeArgs ) as `${typeof PKG_V28}::display::Display<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
...
export class DisplayCreated<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: DisplayCreatedFields<T>, ) { this.$fullTypeName = composeSuiType( DisplayCreated.$typeName, ...typeArgs ) as `${typeof PKG_V28}::display::DisplayCreated<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
...
export class VersionUpdated<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: VersionUpdatedFields<T>, ) { this.$fullTypeName = composeSuiType( VersionUpdated.$typeName, ...typeArgs ) as `${typeof PKG_V28}::display::VersionUpdated<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
