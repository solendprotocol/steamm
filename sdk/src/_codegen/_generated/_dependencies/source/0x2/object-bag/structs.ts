...
export class ObjectBag implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: ObjectBagFields, ) { this.$fullTypeName = composeSuiType( ObjectBag.$typeName, ...typeArgs ) as `${typeof PKG_V28}::object_bag::ObjectBag`; this.$typeArgs = typeArgs;
