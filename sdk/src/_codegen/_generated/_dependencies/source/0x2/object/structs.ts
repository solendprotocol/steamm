...
export class ID implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: IDFields, ) { this.$fullTypeName = composeSuiType( ID.$typeName, ...typeArgs ) as `${typeof PKG_V28}::object::ID`; this.$typeArgs = typeArgs;
...
export class UID implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: UIDFields, ) { this.$fullTypeName = composeSuiType( UID.$typeName, ...typeArgs ) as `${typeof PKG_V28}::object::UID`; this.$typeArgs = typeArgs;
