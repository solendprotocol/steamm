...
export class Random implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: RandomFields, ) { this.$fullTypeName = composeSuiType( Random.$typeName, ...typeArgs ) as `${typeof PKG_V28}::random::Random`; this.$typeArgs = typeArgs;
...
export class RandomGenerator implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: RandomGeneratorFields, ) { this.$fullTypeName = composeSuiType( RandomGenerator.$typeName, ...typeArgs ) as `${typeof PKG_V28}::random::RandomGenerator`; this.$typeArgs = typeArgs;
...
export class RandomInner implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: RandomInnerFields, ) { this.$fullTypeName = composeSuiType( RandomInner.$typeName, ...typeArgs ) as `${typeof PKG_V28}::random::RandomInner`; this.$typeArgs = typeArgs;
