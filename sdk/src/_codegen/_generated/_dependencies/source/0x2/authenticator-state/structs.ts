...
export class ActiveJwk implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: ActiveJwkFields, ) { this.$fullTypeName = composeSuiType( ActiveJwk.$typeName, ...typeArgs ) as `${typeof PKG_V28}::authenticator_state::ActiveJwk`; this.$typeArgs = typeArgs;
...
export class AuthenticatorState implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: AuthenticatorStateFields, ) { this.$fullTypeName = composeSuiType( AuthenticatorState.$typeName, ...typeArgs ) as `${typeof PKG_V28}::authenticator_state::AuthenticatorState`; this.$typeArgs = typeArgs;
...
export class AuthenticatorStateInner implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: AuthenticatorStateInnerFields, ) { this.$fullTypeName = composeSuiType( AuthenticatorStateInner.$typeName, ...typeArgs ) as `${typeof PKG_V28}::authenticator_state::AuthenticatorStateInner`; this.$typeArgs = typeArgs;
...
export class JWK implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: JWKFields, ) { this.$fullTypeName = composeSuiType( JWK.$typeName, ...typeArgs ) as `${typeof PKG_V28}::authenticator_state::JWK`; this.$typeArgs = typeArgs;
...
export class JwkId implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: JwkIdFields, ) { this.$fullTypeName = composeSuiType( JwkId.$typeName, ...typeArgs ) as `${typeof PKG_V28}::authenticator_state::JwkId`; this.$typeArgs = typeArgs;
