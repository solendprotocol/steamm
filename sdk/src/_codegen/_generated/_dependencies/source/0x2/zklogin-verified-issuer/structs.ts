...
export class VerifiedIssuer implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: VerifiedIssuerFields, ) { this.$fullTypeName = composeSuiType( VerifiedIssuer.$typeName, ...typeArgs ) as `${typeof PKG_V28}::zklogin_verified_issuer::VerifiedIssuer`; this.$typeArgs = typeArgs;
