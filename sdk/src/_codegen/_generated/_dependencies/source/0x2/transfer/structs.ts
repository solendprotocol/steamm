...
export class Receiving<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: ReceivingFields<T>, ) { this.$fullTypeName = composeSuiType( Receiving.$typeName, ...typeArgs ) as `${typeof PKG_V28}::transfer::Receiving<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
