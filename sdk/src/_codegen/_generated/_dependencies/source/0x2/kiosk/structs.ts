...
export class ItemDelisted<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: ItemDelistedFields<T>, ) { this.$fullTypeName = composeSuiType( ItemDelisted.$typeName, ...typeArgs ) as `${typeof PKG_V28}::kiosk::ItemDelisted<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
...
export class ItemListed<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: ItemListedFields<T>, ) { this.$fullTypeName = composeSuiType( ItemListed.$typeName, ...typeArgs ) as `${typeof PKG_V28}::kiosk::ItemListed<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
...
export class ItemPurchased<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: ItemPurchasedFields<T>, ) { this.$fullTypeName = composeSuiType( ItemPurchased.$typeName, ...typeArgs ) as `${typeof PKG_V28}::kiosk::ItemPurchased<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
...
export class PurchaseCap<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: PurchaseCapFields<T>, ) { this.$fullTypeName = composeSuiType( PurchaseCap.$typeName, ...typeArgs ) as `${typeof PKG_V28}::kiosk::PurchaseCap<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
