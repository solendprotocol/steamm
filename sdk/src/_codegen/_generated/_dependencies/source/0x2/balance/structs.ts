...
export class Balance<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: BalanceFields<T>, ) { this.$fullTypeName = composeSuiType( Balance.$typeName, ...typeArgs ) as `${typeof PKG_V28}::balance::Balance<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
...
export class Supply<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: SupplyFields<T>, ) { this.$fullTypeName = composeSuiType( Supply.$typeName, ...typeArgs ) as `${typeof PKG_V28}::balance::Supply<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
