...
export class AddressKey implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: AddressKeyFields, ) { this.$fullTypeName = composeSuiType( AddressKey.$typeName, ...typeArgs ) as `${typeof PKG_V28}::deny_list::AddressKey`; this.$typeArgs = typeArgs;
...
export class ConfigKey implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: ConfigKeyFields, ) { this.$fullTypeName = composeSuiType( ConfigKey.$typeName, ...typeArgs ) as `${typeof PKG_V28}::deny_list::ConfigKey`; this.$typeArgs = typeArgs;
...
export class ConfigWriteCap implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: ConfigWriteCapFields, ) { this.$fullTypeName = composeSuiType( ConfigWriteCap.$typeName, ...typeArgs ) as `${typeof PKG_V28}::deny_list::ConfigWriteCap`; this.$typeArgs = typeArgs;
...
export class DenyList implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: DenyListFields, ) { this.$fullTypeName = composeSuiType( DenyList.$typeName, ...typeArgs ) as `${typeof PKG_V28}::deny_list::DenyList`; this.$typeArgs = typeArgs;
...
export class GlobalPauseKey implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: GlobalPauseKeyFields, ) { this.$fullTypeName = composeSuiType( GlobalPauseKey.$typeName, ...typeArgs ) as `${typeof PKG_V28}::deny_list::GlobalPauseKey`; this.$typeArgs = typeArgs;
...
export class PerTypeConfigCreated implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: PerTypeConfigCreatedFields, ) { this.$fullTypeName = composeSuiType( PerTypeConfigCreated.$typeName, ...typeArgs ) as `${typeof PKG_V28}::deny_list::PerTypeConfigCreated`; this.$typeArgs = typeArgs;
...
export class PerTypeList implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: PerTypeListFields, ) { this.$fullTypeName = composeSuiType( PerTypeList.$typeName, ...typeArgs ) as `${typeof PKG_V28}::deny_list::PerTypeList`; this.$typeArgs = typeArgs;
