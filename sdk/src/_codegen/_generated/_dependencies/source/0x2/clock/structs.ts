...
export class Clock implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: ClockFields, ) { this.$fullTypeName = composeSuiType( Clock.$typeName, ...typeArgs ) as `${typeof PKG_V28}::clock::Clock`; this.$typeArgs = typeArgs;
