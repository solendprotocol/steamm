...
export class RuleKey<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: RuleKeyFields<T>, ) { this.$fullTypeName = composeSuiType( RuleKey.$typeName, ...typeArgs ) as `${typeof PKG_V28}::transfer_policy::RuleKey<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
...
export class TransferPolicy<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TransferPolicyFields<T>, ) { this.$fullTypeName = composeSuiType( TransferPolicy.$typeName, ...typeArgs ) as `${typeof PKG_V28}::transfer_policy::TransferPolicy<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
...
export class TransferPolicyCap<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TransferPolicyCapFields<T>, ) { this.$fullTypeName = composeSuiType( TransferPolicyCap.$typeName, ...typeArgs ) as `${typeof PKG_V28}::transfer_policy::TransferPolicyCap<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
...
export class TransferPolicyCreated<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TransferPolicyCreatedFields<T>, ) { this.$fullTypeName = composeSuiType( TransferPolicyCreated.$typeName, ...typeArgs ) as `${typeof PKG_V28}::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
...
export class TransferPolicyDestroyed<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TransferPolicyDestroyedFields<T>, ) { this.$fullTypeName = composeSuiType( TransferPolicyDestroyed.$typeName, ...typeArgs ) as `${typeof PKG_V28}::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
...
export class TransferRequest<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TransferRequestFields<T>, ) { this.$fullTypeName = composeSuiType( TransferRequest.$typeName, ...typeArgs ) as `${typeof PKG_V28}::transfer_policy::TransferRequest<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
