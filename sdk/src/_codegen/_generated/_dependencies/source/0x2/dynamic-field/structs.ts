...
export class Field<Name extends TypeArgument, Value extends TypeArgument> implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [ToTypeStr<Name>, ToTypeStr<Value>], fields: FieldFields<Name, Value>, ) { this.$fullTypeName = composeSuiType( Field.$typeName, ...typeArgs ) as `${typeof PKG_V28}::dynamic_field::Field<${ToTypeStr<Name>}, ${ToTypeStr<Value>}>`; this.$typeArgs = typeArgs;
