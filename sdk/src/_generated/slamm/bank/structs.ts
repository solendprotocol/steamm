...
export interface BankFields<P extends PhantomTypeArgument, T extends PhantomTypeArgument> { id: ToField<UID>; fundsAvailable: ToField<Balance<T>>; lending: ToField<Option<Lending<P>>>; version: ToField<Version> }
...
export class Bank<P extends PhantomTypeArgument, T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 readonly id: ToField<UID>; readonly fundsAvailable: ToField<Balance<T>>; readonly lending: ToField<Option<Lending<P>>>; readonly version: ToField<Version>
 ...
 this.id = fields.id;; this.fundsAvailable = fields.fundsAvailable;; this.lending = fields.lending;; this.version = fields.version; }
 ...
 id: UID.bcs, funds_available: Balance.bcs, lending: Option.bcs(Lending.bcs), version: Version.bcs

}) };

 static fromFields<P extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [P, T], fields: Record<string, any> ): Bank<ToPhantomTypeArgument<P>, ToPhantomTypeArgument<T>> { return Bank.reified( typeArgs[0], typeArgs[1], ).new( { id: decodeFromFields(UID.reified(), fields.id), fundsAvailable: decodeFromFields(Balance.reified(typeArgs[1]), fields.funds_available), lending: decodeFromFields(Option.reified(Lending.reified(typeArgs[0])), fields.lending), version: decodeFromFields(Version.reified(), fields.version) } ) }
 ...
 return Bank.reified( typeArgs[0], typeArgs[1], ).new( { id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), fundsAvailable: decodeFromFieldsWithTypes(Balance.reified(typeArgs[1]), item.fields.funds_available), lending: decodeFromFieldsWithTypes(Option.reified(Lending.reified(typeArgs[0])), item.fields.lending), version: decodeFromFieldsWithTypes(Version.reified(), item.fields.version) } ) }
 ...
 id: this.id,fundsAvailable: this.fundsAvailable.toJSONField(),lending: fieldToJSON<Option<Lending<P>>>(`${Option.$typeName}<${Lending.$typeName}<${this.$typeArgs[0]}>>`, this.lending),version: this.version.toJSONField(),

} }

 toJSON() { return { $typeName: this.$typeName, $typeArgs: this.$typeArgs, ...this.toJSONField() } }

 static fromJSONField<P extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [P, T], field: any ): Bank<ToPhantomTypeArgument<P>, ToPhantomTypeArgument<T>> { return Bank.reified( typeArgs[0], typeArgs[1], ).new( { id: decodeFromJSONField(UID.reified(), field.id), fundsAvailable: decodeFromJSONField(Balance.reified(typeArgs[1]), field.fundsAvailable), lending: decodeFromJSONField(Option.reified(Lending.reified(typeArgs[0])), field.lending), version: decodeFromJSONField(Version.reified(), field.version) } ) }
...
export interface LendingFields<P extends PhantomTypeArgument> { lendingMarket: ToField<ID>; fundsDeployed: ToField<"u64">; ctokens: ToField<"u64">; targetUtilisationBps: ToField<"u16">; utilisationBufferBps: ToField<"u16">; reserveArrayIndex: ToField<"u64">; obligationCap: ToField<ObligationOwnerCap<P>> }
...
export class Lending<P extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 readonly lendingMarket: ToField<ID>; readonly fundsDeployed: ToField<"u64">; readonly ctokens: ToField<"u64">; readonly targetUtilisationBps: ToField<"u16">; readonly utilisationBufferBps: ToField<"u16">; readonly reserveArrayIndex: ToField<"u64">; readonly obligationCap: ToField<ObligationOwnerCap<P>>
 ...
 this.lendingMarket = fields.lendingMarket;; this.fundsDeployed = fields.fundsDeployed;; this.ctokens = fields.ctokens;; this.targetUtilisationBps = fields.targetUtilisationBps;; this.utilisationBufferBps = fields.utilisationBufferBps;; this.reserveArrayIndex = fields.reserveArrayIndex;; this.obligationCap = fields.obligationCap; }
 ...
 lending_market: ID.bcs, funds_deployed: bcs.u64(), ctokens: bcs.u64(), target_utilisation_bps: bcs.u16(), utilisation_buffer_bps: bcs.u16(), reserve_array_index: bcs.u64(), obligation_cap: ObligationOwnerCap.bcs

}) };

 static fromFields<P extends PhantomReified<PhantomTypeArgument>>( typeArg: P, fields: Record<string, any> ): Lending<ToPhantomTypeArgument<P>> { return Lending.reified( typeArg, ).new( { lendingMarket: decodeFromFields(ID.reified(), fields.lending_market), fundsDeployed: decodeFromFields("u64", fields.funds_deployed), ctokens: decodeFromFields("u64", fields.ctokens), targetUtilisationBps: decodeFromFields("u16", fields.target_utilisation_bps), utilisationBufferBps: decodeFromFields("u16", fields.utilisation_buffer_bps), reserveArrayIndex: decodeFromFields("u64", fields.reserve_array_index), obligationCap: decodeFromFields(ObligationOwnerCap.reified(typeArg), fields.obligation_cap) } ) }
 ...
 lendingMarket: this.lendingMarket,fundsDeployed: this.fundsDeployed.toString(),ctokens: this.ctokens.toString(),targetUtilisationBps: this.targetUtilisationBps,utilisationBufferBps: this.utilisationBufferBps,reserveArrayIndex: this.reserveArrayIndex.toString(),obligationCap: this.obligationCap.toJSONField(),

} }

 toJSON() { return { $typeName: this.$typeName, $typeArgs: this.$typeArgs, ...this.toJSONField() } }

 static fromJSONField<P extends PhantomReified<PhantomTypeArgument>>( typeArg: P, field: any ): Lending<ToPhantomTypeArgument<P>> { return Lending.reified( typeArg, ).new( { lendingMarket: decodeFromJSONField(ID.reified(), field.lendingMarket), fundsDeployed: decodeFromJSONField("u64", field.fundsDeployed), ctokens: decodeFromJSONField("u64", field.ctokens), targetUtilisationBps: decodeFromJSONField("u16", field.targetUtilisationBps), utilisationBufferBps: decodeFromJSONField("u16", field.utilisationBufferBps), reserveArrayIndex: decodeFromJSONField("u64", field.reserveArrayIndex), obligationCap: decodeFromJSONField(ObligationOwnerCap.reified(typeArg), field.obligationCap) } ) }
