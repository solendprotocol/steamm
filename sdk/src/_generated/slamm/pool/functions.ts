...
export function swap(
  ...
  return tx.moveCall({
    ...
    arguments: [
      obj(tx, args.self),
      generic(tx, `${typeArgs[2]}`, args.witness),
      obj(tx, args.bankA),
      obj(tx, args.bankB),
      obj(tx, args.coinA),
      obj(tx, args.coinB),
...
export function new_(
  ...
  return tx.moveCall({
    ...
    arguments: [
      ...
      generic(tx, `${typeArgs[3]}`, args.inner),
    ],
  });
}
...
export function deposit(
  ...
  return tx.moveCall({
    ...
    typeArguments: typeArgs,
    arguments: [obj(tx, args.funds), obj(tx, args.bank), obj(tx, args.balance)],
  });
}
...
export function migrate(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::migrate`,
    typeArguments: typeArgs,
...
export function migrateAsGlobalAdmin(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::migrate_as_global_admin`,
    typeArguments: typeArgs,
...
export function totalFunds(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::total_funds`,
    typeArguments: typeArgs,
...
export function protocolFees(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::protocol_fees`,
    typeArguments: typeArgs,
    arguments: [obj(tx, self)],
  });
}
...
export function assertLpSupplyReserveRatio(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::assert_lp_supply_reserve_ratio`,
    arguments: [
...
export function quoteDeposit(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::quote_deposit`,
    typeArguments: typeArgs,
    arguments: [
      obj(tx, args.self),
      pure(tx, args.idealA, `u64`),
      pure(tx, args.idealB, `u64`),
    ],
  });
}
...
export function quoteRedeem(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::quote_redeem`,
    typeArguments: typeArgs,
    arguments: [obj(tx, args.self), pure(tx, args.lpTokens, `u64`)],
  });
}

export interface AsIntentArgs {
  quote: TransactionObjectInput;
  pool: TransactionObjectInput;
}

export function asIntent(
  tx: Transaction,
  typeArgs: [string, string, string, string],
  args: AsIntentArgs
) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::as_intent`,
    typeArguments: typeArgs,
    arguments: [obj(tx, args.quote), obj(tx, args.pool)],
  });
}
...
export function assertGuarded(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::assert_guarded`,
    typeArguments: typeArgs,
...
export function assertLiquidity(tx: Transaction, args: AssertLiquidityArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::assert_liquidity`,
    arguments: [
...
export function assertUnguarded(
  tx: Transaction,
  typeArgs: [string, string, string, string],
  pool: TransactionObjectInput
) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::assert_unguarded`,
    typeArguments: typeArgs,
    arguments: [obj(tx, pool)],
  });
}
...
export function collectProtocolFees(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::collect_protocol_fees`,
    typeArguments: typeArgs,
    arguments: [obj(tx, args.self), obj(tx, args.globalAdmin)],
  });
}
...
export function collectRedemptionFees(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::collect_redemption_fees`,
    typeArguments: typeArgs,
    arguments: [obj(tx, args.self), obj(tx, args.cap)],
  });
}
...
export function computeRedemptionFees_(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::compute_redemption_fees_`,
    typeArguments: typeArgs,
    arguments: [
      obj(tx, args.self),
...
export function computeSwapFees_(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::compute_swap_fees_`,
    typeArguments: typeArgs,
...
export function consume(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::consume`,
    typeArguments: typeArgs,
    arguments: [obj(tx, args.pool), obj(tx, args.intent)],
  });
}
...
export function depositLiquidity(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::deposit_liquidity`,
    typeArguments: typeArgs,
    arguments: [
      obj(tx, args.self),
      obj(tx, args.bankA),
...
export function depositResultDepositA(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::deposit_result_deposit_a`,
    arguments: [obj(tx, self)],
  });
}
...
export function depositResultDepositB(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::deposit_result_deposit_b`,
    arguments: [obj(tx, self)],
  });
}
...
export function depositResultMintLp(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::deposit_result_mint_lp`,
    arguments: [obj(tx, self)],
  });
}
...
export function depositResultPoolId(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::deposit_result_pool_id`,
    arguments: [obj(tx, self)],
  });
}
...
export function depositResultUser(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::deposit_result_user`,
    arguments: [obj(tx, self)],
  });
}
...
export function getQuote(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::get_quote`,
    typeArguments: typeArgs,
    arguments: [
      obj(tx, args.self),
...
export function guard(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::guard`,
    typeArguments: typeArgs,
    arguments: [obj(tx, pool)],
  });
}
...
export function inner(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::inner`,
    typeArguments: typeArgs,
    arguments: [obj(tx, pool)],
  });
}
...
export function innerMut(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::inner_mut`,
    typeArguments: typeArgs,
    arguments: [obj(tx, self)],
  });
}

export function intentQuote(
  tx: Transaction,
  typeArgs: [string, string, string, string],
  self: TransactionObjectInput
) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::intent_quote`,
    typeArguments: typeArgs,
    arguments: [obj(tx, self)],
  });
}
...
export function lpSupplyVal(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::lp_supply_val`,
    typeArguments: typeArgs,
    arguments: [obj(tx, self)],
  });
}

export function minimumLiquidity(tx: Transaction) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::minimum_liquidity`,
    arguments: [],
  });
}

export interface NeedsLendingActionOnSwapArgs {
  self: TransactionObjectInput;
  bankA: TransactionObjectInput;
  bankB: TransactionObjectInput;
  quote: TransactionObjectInput;
...
export function needsLendingActionOnSwap(
  tx: Transaction,
  typeArgs: [string, string, string, string, string],
  args: NeedsLendingActionOnSwapArgs
) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::needs_lending_action_on_swap`,
    typeArguments: typeArgs,
    arguments: [
      obj(tx, args.self),
      obj(tx, args.bankA),
...
export interface NeedsLendingActionOnSwap_Args {
  bankIn: TransactionObjectInput;
  bankOut: TransactionObjectInput;
  amountIn: bigint | TransactionArgument;
  amountOut: bigint | TransactionArgument;
}

export function needsLendingActionOnSwap_(
  tx: Transaction,
  typeArgs: [string, string, string],
  args: NeedsLendingActionOnSwap_Args
) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::needs_lending_action_on_swap_`,
    typeArguments: typeArgs,
    arguments: [
      obj(tx, args.bankIn),
      obj(tx, args.bankOut),
...
export function poolFeeConfig(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::pool_fee_config`,
    typeArguments: typeArgs,
    arguments: [obj(tx, self)],
  });
}

export function poolFeesA(tx: Transaction, self: TransactionObjectInput) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::pool_fees_a`,
    arguments: [obj(tx, self)],
  });
}

export function poolFeesB(tx: Transaction, self: TransactionObjectInput) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::pool_fees_b`,
    arguments: [obj(tx, self)],
  });
}

export interface PrepareBankForPendingWithdrawArgs {
  bankA: TransactionObjectInput;
  bankB: TransactionObjectInput;
...
export function prepareBankForPendingWithdraw(
  tx: Transaction,
  typeArgs: [string, string, string, string, string],
  args: PrepareBankForPendingWithdrawArgs
) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::prepare_bank_for_pending_withdraw`,
    typeArguments: typeArgs,
    arguments: [
      obj(tx, args.bankA),
      obj(tx, args.bankB),
...
export function protocolFeesA(tx: Transaction, self: TransactionObjectInput) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::protocol_fees_a`,
    arguments: [obj(tx, self)],
  });
}

export function protocolFeesB(tx: Transaction, self: TransactionObjectInput) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::protocol_fees_b`,
    arguments: [obj(tx, self)],
  });
}

export interface QuoteDepositImplArgs {
  self: TransactionObjectInput;
  idealA: bigint | TransactionArgument;
  idealB: bigint | TransactionArgument;
  minA: bigint | TransactionArgument;
...
export function quoteDepositImpl(
  tx: Transaction,
  typeArgs: [string, string, string, string],
  args: QuoteDepositImplArgs
) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::quote_deposit_impl`,
    typeArguments: typeArgs,
    arguments: [
      obj(tx, args.self),
      pure(tx, args.idealA, `u64`),
...
export interface QuoteRedeemImplArgs {
  self: TransactionObjectInput;
  lpTokens: bigint | TransactionArgument;
  minA: bigint | TransactionArgument;
  minB: bigint | TransactionArgument;
...
export function quoteRedeemImpl(
  tx: Transaction,
  typeArgs: [string, string, string, string],
  args: QuoteRedeemImplArgs
) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::quote_redeem_impl`,
    typeArguments: typeArgs,
    arguments: [
      obj(tx, args.self),
...
export function redeemLiquidity(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::redeem_liquidity`,
    typeArguments: typeArgs,
    arguments: [
      obj(tx, args.self),
      obj(tx, args.bankA),
...
export function redeemResultBurnLp(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::redeem_result_burn_lp`,
    arguments: [obj(tx, self)],
  });
}
...
export function redeemResultPoolId(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::redeem_result_pool_id`,
    arguments: [obj(tx, self)],
  });
}
...
export function redeemResultUser(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::redeem_result_user`,
    arguments: [obj(tx, self)],
  });
}
...
export function redeemResultWithdrawA(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::redeem_result_withdraw_a`,
    arguments: [obj(tx, self)],
  });
}
...
export function redeemResultWithdrawB(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::redeem_result_withdraw_b`,
    arguments: [obj(tx, self)],
  });
}
...
export function setPoolSwapFees(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::set_pool_swap_fees`,
    typeArguments: typeArgs,
    arguments: [
      obj(tx, args.pool),
      obj(tx, args.poolCap),
...
export function setRedemptionFees(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::set_redemption_fees`,
    typeArguments: typeArgs,
    arguments: [
      obj(tx, args.pool),
      obj(tx, args.poolCap),
...
export function swapInner(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::swap_inner`,
    typeArguments: typeArgs,
    arguments: [
      obj(tx, args.quote),
      obj(tx, args.bankIn),
...
export function swapResultA2b(tx: Transaction, self: TransactionObjectInput) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::swap_result_a2b`,
    arguments: [obj(tx, self)],
  });
}
...
export function swapResultAmountIn(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::swap_result_amount_in`,
    arguments: [obj(tx, self)],
  });
}
...
export function swapResultAmountOut(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::swap_result_amount_out`,
    arguments: [obj(tx, self)],
  });
}
...
export function swapResultPoolFees(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::swap_result_pool_fees`,
    arguments: [obj(tx, self)],
  });
}
...
export function swapResultPoolId(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::swap_result_pool_id`,
    arguments: [obj(tx, self)],
  });
}
...
export function swapResultProtocolFees(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::swap_result_protocol_fees`,
    arguments: [obj(tx, self)],
  });
}

export function swapResultUser(tx: Transaction, self: TransactionObjectInput) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::swap_result_user`,
    arguments: [obj(tx, self)],
  });
}

export function totalFundsA(
  tx: Transaction,
  typeArgs: [string, string, string, string],
  self: TransactionObjectInput
) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::total_funds_a`,
    typeArguments: typeArgs,
    arguments: [obj(tx, self)],
  });
}

export function totalFundsB(
  tx: Transaction,
  typeArgs: [string, string, string, string],
  self: TransactionObjectInput
) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::total_funds_b`,
    typeArguments: typeArgs,
    arguments: [obj(tx, self)],
  });
}
...
export function totalSwapAInAmount(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::total_swap_a_in_amount`,
    arguments: [obj(tx, self)],
  });
}
...
export function totalSwapAOutAmount(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::total_swap_a_out_amount`,
    arguments: [obj(tx, self)],
  });
}
...
export function totalSwapBInAmount(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::total_swap_b_in_amount`,
    arguments: [obj(tx, self)],
  });
}
...
export function totalSwapBOutAmount(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::total_swap_b_out_amount`,
    arguments: [obj(tx, self)],
  });
}
...
export function tradingData(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::trading_data`,
    typeArguments: typeArgs,
    arguments: [obj(tx, self)],
  });
}
...
export function unguard(
  ...
  return tx.moveCall({
    target: `${PUBLISHED_AT}::pool::unguard`,
    typeArguments: typeArgs,
    arguments: [obj(tx, pool)],
  });
}
